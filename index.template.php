...
<head>
    <link rel="shortcut icon" href="https://cdn.southcenter.es/static/favicon.ico" >
...
<script type=”text/javascript”>
var pageTracker = _gat._getTracker(”UA-104673751-1″);
...
<header>
	<div class="container">
		<div class="row">
			...
			{
			echo'
				<button type="button" class="btn btn-success" onclick="location.href=\''. $scripturl .'?action=login\'">', $txt['login'] ,'</button>
		...
		<footer>
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
					SouthCenter — Juego de Rol &copy 2016. Todos los derechos reservados | Página creada por Beck Solutions LLC
					</div>';
					/* <!-- <div class="col-lg-12">
						 Copyright &copy 2017 ', !empty($settings['reseller_copyright']) ? $settings['reseller_copyright'] : $context['forum_name'] .'. All Rights Reserved.
